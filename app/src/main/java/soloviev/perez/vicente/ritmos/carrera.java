...
public class carrera extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabHost.addTab(tabHost.newTabSpec("tiempo").setIndicator(getResources().getString(R.string.calcular_tiempo)), tiempo.class, null);
        tabHost.addTab(tabHost.newTabSpec("ritmo").setIndicator(getResources().getString(R.string.calcular_ritmo)), ritmo.class, null);
        tabHost.addTab(tabHost.newTabSpec("distancia").setIndicator(getResources().getString(R.string.calcular_distancia)), distancia.class, null);

        //actualizo nombre de actionBar para idioma

        setTitle(R.string.calculadora_carrera);
    }
    ...
    public void calcular_ritmo (View view) {
        ...
        if (Integer.decode(distancia_ritmo.getText().toString()).equals(0) && Integer.decode(tiempo_sec_ritmo.getText().toString()).equals(0) &&
            ...
            ritmo_sec_ritmo.setText(Float.toString(r));
        }
    ...
    public void calcular_tiempo (View view) {
        ...
        if (distancia_tiempo.getText().toString().equals(0) && ritmo_min.getText().toString().equals(0) && ritmo_sec.getText().toString().equals(0) ) {
            horas_tiempo.setText(0);
            min_tiempo.setText(0);
            sec_tiempo.setText(0);
        }
        if (!TextUtils.isEmpty(distancia_tiempo.getText()) && !TextUtils.isEmpty(ritmo_min.getText())&& !TextUtils.isEmpty(ritmo_sec.getText())) {
            ...
            int tot = min*60 + sec;
            int mult = (dist * tot) / 1000;

            int h=mult/3600;
            int mi=(mult-(3600*h))/60;
    ...
    public void calcular_distancia (View view) {
        ...
        if (Integer.decode(ritmo_min_distancia.getText().toString()).equals(0) && Integer.decode(ritmo_sec_distancia.getText().toString()).equals(0) && Integer.decode(tiempo_horas_distancia.getText().toString()).equals(0) &&
            ...
            int ritmo_a_sec = (q*60) + w;

            float tot = (float) ((float) tiempo_a_sec / (float) ritmo_a_sec) * 1000;
